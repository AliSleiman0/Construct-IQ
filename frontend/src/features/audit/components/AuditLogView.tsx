...
interface AuditLogViewProps {
  /**
   * Copy only. Scope is enforced server-side: `AuditService.findAll` gives
   * super admins every org and everyone else their own, so the same component
   * serves /super-admin/audit-log and /admin/audit-log.
   */
  subtitle?: string;
}

export function AuditLogView({ subtitle }: AuditLogViewProps) {
  ...
  return (
    <Box>
      <PageHeader
        title="Audit Log"
        subtitle={subtitle ?? 'Activity feed. All writes and login events.'}
      />
