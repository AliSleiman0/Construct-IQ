...
// ORG_ADMIN holds manage:company, a wildcard that satisfies every procurement
// permission — so every affordance is on. Same composition as /pm/procurement.
export default function AdminProcurementPage() {
  ...
  return (
    <Box>
      <PageHeader title="Procurement" subtitle="Suppliers, purchase orders, and deliveries across the company." />
