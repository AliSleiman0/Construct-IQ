        ...
        <>
          ...
          <Box sx={{ display: 'grid', gap: 2.5, gridTemplateColumns: { xs: '1fr', md: '1fr 1fr' }, mb: 2.5 }}>
            ...
            <DashboardPanel title="Issues by Severity" subtitle="Open issues, last 30 days">
              <MiniBarChart
                data={[
                  { label: 'Critical', value: dashboard.openIssuesByPriority.critical, color: '#d32f2f' },
                  { label: 'High', value: dashboard.openIssuesByPriority.high, color: '#ed6c02' },
                  { label: 'Medium', value: dashboard.openIssuesByPriority.medium, color: '#0288d1' },
                  { label: 'Low', value: dashboard.openIssuesByPriority.low, color: '#9e9e9e' },
                ]}
              />
            </DashboardPanel>
          </Box>
