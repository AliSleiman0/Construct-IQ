...
import { NavScroll } from './_landing/NavScroll';
import { ParticlesField } from './_landing/ParticlesField';
import { Typewriter } from './_landing/Typewriter';
import { ScrollReveal } from './_landing/ScrollReveal';
import { FeatureCardGlow } from './_landing/FeatureCardGlow';
import { AiChatAutoplay } from './_landing/AiChatAutoplay';
    ...
    <div className="landing-page">
        ...
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          <a href="#" className="flex items-center gap-2.5 group">
            ...
            <span className="text-lg font-bold tracking-tight">
              Construct<span className="text-blue-400">IQ</span>
            </span>
          </a>
          <div className="hidden md:flex items-center gap-8 text-sm text-white/60">
            {['features', 'how-it-works', 'pricing', 'testimonials'].map((id) => (
              <a
                key={id}
                href={`#${id}`}
                className="hover:text-white transition-colors relative group capitalize"
              >
                {id.replace('-', ' ')}
          ...
          <div className="hidden md:flex items-center gap-3">
            ...
            <Link
              href="/login"
              className="btn-amber text-sm font-bold bg-amber-500 text-navy-900 px-5 py-2.5 rounded-xl"
            >
              Get Started Free
            </Link>
          </div>
        ...
        <div className="relative max-w-7xl mx-auto px-6 py-24 grid lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <p className="text-lg text-white/55 leading-relaxed mb-10 max-w-lg">
              ConstructIQ gives your field teams and office staff one place to manage projects,
              track budgets, file daily reports, and get AI-powered answers — from ground-break to
              handover.
            </p>
            <div className="flex gap-8 mb-10">
              <div>
                <div className="stat-number text-3xl font-extrabold stat-val" data-count="47" data-suffix="%">
                  0%
                </div>
              ...
              <div>
                <div className="stat-number text-3xl font-extrabold stat-val" data-count="600" data-suffix="+">
                  0+
                </div>
              ...
              <div className="w-px bg-white/10" />
              <div>
                <div className="stat-number text-3xl font-extrabold stat-val" data-count="99" data-suffix=".9%">
                  0%
                </div>
            ...
            <div className="flex flex-wrap gap-4">
              <Link
                href="/login"
                className="btn-amber inline-flex items-center gap-2 bg-amber-500 text-navy-900 font-bold px-7 py-3.5 rounded-xl text-sm"
              >
                Get Started Free
              ...
              <a
                href="#features"
                className="btn-outline inline-flex items-center gap-2 border border-white/20 text-white font-semibold px-7 py-3.5 rounded-xl text-sm"
              >
                <svg width="15" height="15" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 16 16">
          ...
          <div className="relative flex items-center justify-center">
            <div className="dash-float w-full max-w-md">
                ...
                <div className="p-4 space-y-3">
                  <div className="grid grid-cols-3 gap-2.5">
                    {[
                      ...
                      >
                        ...
                        <div className="text-xl font-bold" id={id}>
                          0{id === 'dash-budget' ? '%' : ''}
                        </div>
                  ...
                  <div className="space-y-1.5">
                    ...
                    {[
                      ...
                      <div
                        key={name}
                        className="flex items-center gap-3 bg-white/[0.04] border border-white/[0.05] rounded-lg px-3 py-2"
                      >
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <div className="h-1 bg-white/[0.08] rounded-full mt-1 overflow-hidden">
                            <div
                              className={`bar-fill h-full ${color} rounded-full`}
                  ...
                  <div className="bg-blue-500/10 border border-blue-500/20 rounded-xl p-3 flex gap-3 items-start">
                    ...
                    <div>
                      ...
                      <div className="text-[11px] text-white/55 leading-relaxed">
                        Riverside Tower has 3 unresolved issues in today&apos;s report. Want a summary?
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div
                className="absolute -bottom-3 -left-4 flex items-center gap-2 bg-emerald-500 text-white text-[11px] font-bold px-3 py-1.5 rounded-full shadow-lg animate-bounce"
                style={{ animationDuration: '3s' }}
              >
                ✓ 3 field reports filed
              </div>
              <div
                className="absolute -top-3 -right-4 flex items-center gap-2 bg-navy-900 border border-white/10 text-[11px] px-3 py-1.5 rounded-full shadow-lg"
                style={{ animation: 'dashFloat 4s 1s ease-in-out infinite' }}
              >
          ...
          <div className="mb-20 reveal">
            <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-6">
              <h2 className="text-5xl lg:text-6xl font-extrabold leading-[1.05] tracking-tight max-w-xl">
                ...
                <em className="not-italic" style={{ color: 'rgba(255,255,255,0.3)' }}>
                  It doesn&apos;t have to.
                </em>
              </h2>
            ...
            {[
              {
                ...
                problem:
                  'Project data lives across email threads, shared drives, and disconnected apps. Nobody knows the real status until something breaks.',
                fix: 'One unified platform — projects, tasks, budgets, and docs — visible in real-time to everyone with the right permissions.',
              },
              {
                num: '02',
                delay: 'delay-2',
                title: 'Reporting eats half the day.',
                problem:
                  'Site supervisors spend 30–60 minutes filling out daily logs and chasing updates — time that belongs on the site, not in spreadsheets.',
                fix: 'Structured report forms that auto-populate from task updates. AI summarizes everything for management — in seconds, not hours.',
              },
              {
                num: '03',
                delay: 'delay-3',
                title: 'Overruns blindside you.',
                problem:
                  'By the time a cost overrun shows up in a report, the damage is done. Purchase orders get approved with no budget context at all.',
                fix: 'Live budget tracking against every phase and PO. Alerts fire before costs spiral — with a full audit trail behind every approval.',
              },
            ].map(({ num, delay, title, problem, fix }) => (
              <div
                key={num}
                className={`prob-row reveal ${delay} grid grid-cols-[auto_1fr] lg:grid-cols-[auto_1fr_1fr] gap-x-8 lg:gap-x-16 items-start py-10 cursor-default`}
              >
                <div className="prob-num row-span-2 lg:row-span-1 pr-4 lg:pr-0">{num}</div>
                <div className="lg:col-span-1">
                  <p className="text-xs text-red-400/70 font-semibold uppercase tracking-widest mb-3">
                    The problem
                  </p>
                  <h3 className="text-2xl lg:text-3xl font-bold mb-3 leading-snug">
                    <span className="prob-strike">{title}</span>
                  </h3>
                  <p className="text-white/40 text-sm leading-relaxed max-w-sm">{problem}</p>
                </div>
                <div className="col-start-2 lg:col-start-auto mt-6 lg:mt-0 flex flex-col justify-start">
                  <div className="flex items-center gap-3 mb-3">
                    <div className="prob-arrow">
                      <svg width="14" height="14" fill="none" stroke="rgba(52,211,153,0.7)" strokeWidth="2">
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-20 reveal">
            <h2 className="text-4xl lg:text-5xl font-extrabold mb-5">
              Everything your crew needs.<br />Nothing they don&apos;t.
            </h2>
            <p className="text-white/45 max-w-lg mx-auto text-lg">
              Purpose-built for how construction teams actually work.
            </p>
          </div>
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {[
              {
                delay: 'delay-1',
                icon: (
                  <svg width="20" height="20" fill="none" stroke="#42a5f5" strokeWidth="2" viewBox="0 0 24 24">
                    <rect x="3" y="3" width="18" height="18" rx="2" />
                    <path d="M3 9h18M9 21V9" />
                  </svg>
                ),
                title: 'Project & Phase Management',
                desc: 'Track projects, phases, and milestones end-to-end. Real-time completion status at a glance.',
              },
              {
                delay: 'delay-2',
                icon: (
                ...
                title: 'Task & Dependency Tracking',
                desc: 'Assign work, set dependencies, and surface blockers before they delay the schedule.',
              },
              {
                delay: 'delay-3',
                icon: (
                ...
                title: 'Daily Reports & Issues',
                desc: 'Field teams submit structured daily logs. Issues flagged, tracked, and resolved in one place.',
              },
              {
                delay: 'delay-4',
                icon: (
                ...
                desc: 'Manage POs, track costs by phase, and catch overruns before they compound.',
              },
              {
                delay: 'delay-5',
                icon: (
                ...
                desc: 'Centralized storage for drawings, specs, permits — version-controlled and always accessible.',
              },
            ].map(({ delay, icon, title, desc }) => (
              <div key={title} className={`feature-card reveal ${delay} rounded-2xl p-6 cursor-default`}>
                <div className="icon-wrap w-11 h-11 rounded-xl bg-blue-500/15 flex items-center justify-center mb-5">
                  {icon}
                </div>
            ...
            <div
              className="feature-card animated-border reveal delay-6 rounded-2xl p-6 cursor-default"
              style={{ background: 'rgba(25,118,210,0.08)', borderColor: 'rgba(25,118,210,0.25)' }}
            >
              <div
                className="icon-wrap w-11 h-11 rounded-xl bg-blue-500/25 flex items-center justify-center mb-5"
                style={{ boxShadow: '0 0 20px rgba(25,118,210,0.3)' }}
              >
                <svg width="20" height="20" fill="#42a5f5" viewBox="0 0 24 24">
                  <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-2 14.5v-9l6 4.5-6 4.5z" />
                </svg>
              </div>
              <div className="flex items-center gap-2 mb-2">
                <h3 className="text-base font-bold">AI Assistant</h3>
                <span className="text-[10px] bg-blue-500 text-white px-2 py-0.5 rounded-full font-bold uppercase tracking-wide">
                  New
                </span>
              </div>
              <p className="text-sm text-blue-200/55 leading-relaxed">
                Ask in plain English. Navigate the app, summarize reports, surface insights instantly.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-32 bg-navy-950 relative overflow-hidden" id="ai">
        ...
        <div className="relative max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-20 items-center">
          <div className="reveal-left">
            <div className="inline-block bg-blue-500/10 text-blue-400 text-xs font-semibold px-3 py-1.5 rounded-full border border-blue-500/20 mb-6">
              AI Assistant
            </div>
            <h2 className="text-4xl lg:text-5xl font-extrabold mb-6 leading-tight">
              Ask your data<br />anything.<br />
              <span className="text-blue-400">Navigate in seconds.</span>
            </h2>
            <p className="text-white/50 mb-8 text-lg leading-relaxed">
              Stop hunting through tabs. ConstructIQ&apos;s AI knows your projects, your team, your site — just ask.
            </p>
              ...
              {[
                ...
                <li key={item} className="flex items-start gap-3 group">
                  <div className="w-6 h-6 rounded-full bg-blue-500/20 flex items-center justify-center mt-0.5 flex-shrink-0 transition-all group-hover:bg-blue-500/40 group-hover:scale-110">
                    <svg width="10" height="10" fill="none" stroke="#42a5f5" strokeWidth="2.5" viewBox="0 0 10 8">
      ...
      <section className="py-32 bg-navy-900" id="how-it-works">
        <div className="max-w-5xl mx-auto px-6">
          <div className="text-center mb-20 reveal">
            <div className="inline-block bg-amber-500/10 text-amber-400 text-xs font-semibold px-3 py-1.5 rounded-full border border-amber-500/20 mb-5">
              Getting Started
            </div>
          ...
          <div className="relative grid md:grid-cols-3 gap-8">
            <div
              className="hidden md:block absolute top-10 left-[calc(16.66%+40px)] right-[calc(16.66%+40px)] h-px"
              style={{
                background:
                  'linear-gradient(90deg,rgba(25,118,210,0.6),rgba(25,118,210,0.1),rgba(25,118,210,0.6))',
              }}
            />
            {[
          ...
          <div className="grid md:grid-cols-3 gap-5">
            <div className="pricing-card reveal delay-1 bg-white/[0.03] border border-white/10 rounded-2xl p-8">
              ...
              <div className="text-5xl font-extrabold mb-1">
                $49<span className="text-xl font-normal text-white/35">/mo</span>
              </div>
              ...
              <Link
                href="/login"
                className="block text-center text-sm font-semibold border border-white/15 hover:border-white/35 text-white py-3 rounded-xl transition-all"
              >
                Start Free Trial
              </Link>
            </div>
            ...
            <div className="pricing-card featured reveal delay-2 rounded-2xl p-8 relative">
              <div className="absolute -top-3.5 left-1/2 -translate-x-1/2 bg-blue-500 text-white text-xs font-bold px-4 py-1 rounded-full shadow-[0_0_20px_rgba(25,118,210,0.5)]">
                Most Popular
              </div>
              <div className="text-sm font-semibold text-blue-400 mb-1">Pro</div>
              <div className="text-5xl font-extrabold mb-1">
                $149<span className="text-xl font-normal text-white/35">/mo</span>
              </div>
              ...
              <Link
                href="/login"
                className="btn-amber block text-center text-sm font-bold bg-amber-500 text-navy-900 py-3 rounded-xl"
              >
                Start Free Trial
              </Link>
            </div>
            ...
            <div className="pricing-card reveal delay-3 bg-white/[0.03] border border-white/10 rounded-2xl p-8">
              ...
              <a
                href="mailto:sales@constructiq.com"
                className="block text-center text-sm font-semibold border border-white/15 hover:border-white/35 text-white py-3 rounded-xl transition-all"
              >
                Contact Sales
              </a>
            ...
            {[
              {
                delay: 'delay-1',
                quote:
                  '"We cut weekly reporting time in half. The AI summary feature alone saves me 90 minutes every Monday morning. I don\'t know how we managed without it."',
                initials: 'DK',
                name: 'D. Kowalski',
                role: 'Senior PM · Meridian Build',
                color: 'bg-blue-500/20 text-blue-300',
              },
              {
                delay: 'delay-2',
                quote:
                  '"Budget overruns used to blindside us. Now we get alerts at 70% spend and course-correct in real time. The procurement module paid for itself in month one."',
                initials: 'SL',
                name: 'S. Lindqvist',
                role: 'Operations Director · Apex Structures',
                color: 'bg-amber-500/20 text-amber-300',
              },
              {
                delay: 'delay-3',
                quote:
                  '"My crews were skeptical at first. Now they won\'t go back — daily reports take 10 minutes, issues get flagged instantly, nothing falls through the cracks."',
                initials: 'RC',
                name: 'R. Chen',
                role: 'Site Supervisor · Delta Contracting',
                color: 'bg-emerald-500/20 text-emerald-300',
              },
            ].map(({ delay, quote, initials, name, role, color }) => (
              <div
                key={name}
                className={`testimonial-card reveal ${delay} bg-white/[0.03] border border-white/[0.08] rounded-2xl p-7`}
              >
      ...
      <section
        ...
        style={{ background: 'linear-gradient(135deg,#0f1623 0%,#1a2840 40%,#0f1623 100%)' }}
      >
        <div className="absolute inset-0 pointer-events-none">
          <div
            style={{
              ...
              inset: '-50%',
              background:
                'radial-gradient(ellipse 50% 60% at 30% 50%,rgba(25,118,210,0.2),transparent 70%),radial-gradient(ellipse 40% 50% at 70% 50%,rgba(66,165,245,0.08),transparent 70%)',
        ...
        <div className="relative max-w-4xl mx-auto px-6 text-center reveal">
          ...
          <div className="flex flex-wrap gap-4 justify-center">
            <Link
              href="/login"
              className="btn-amber inline-flex items-center gap-2.5 bg-amber-500 text-navy-900 font-extrabold px-9 py-4 rounded-xl text-base"
            >
              Start Free Trial
            ...
            <a
              href="#features"
              className="btn-outline inline-flex items-center gap-2.5 border border-white/20 text-white font-semibold px-9 py-4 rounded-xl text-base"
            >
              See Features
            </a>
          </div>
          ...
          <div className="grid md:grid-cols-4 gap-10 mb-12">
            <div>
              ...
              <p className="text-xs text-white/35 leading-relaxed mb-5">
                Construction management software built for the modern job site.
              </p>
              <div className="flex gap-2">
                ...
                >
                  <svg width="13" height="13" fill="currentColor" viewBox="0 0 16 16" className="text-white/40">
